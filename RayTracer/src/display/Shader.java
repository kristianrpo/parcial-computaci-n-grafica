...
public class Shader {
    ...
    public static Colour computeLocalIllumination(Vector4 point, Vector4 N, 
        ...
        Colour ambient = Olambda.timesColour(IaLambda.timesScalar(Ka));     // ***
        ...
        for (Light light : Scene.lights) {
            ...
            if (dot > 0 && s == null) {
                ...
                Colour diffuse = Olambda.timesColour(IpLambda.timesScalar(Kd).timesScalar(dot));   // ***
                ...
                double finalDot = Math.pow(dot3,n);
                if (dot3 > 0) {
                    specular = IpLambda.timesScalar(Ks).timesScalar(finalDot);    // ***
                }
